...
import type { SeatTooltip } from '../components/hemicycle/hemicycle-seats';
import {
  buildKeyHandler,
  buildSeatInteractions,
} from '../components/seat/seat-interactions';

import type { HemicycleLayoutResult } from './use-hemicycle-layout';
