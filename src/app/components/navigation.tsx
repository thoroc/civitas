...
interface NavItemProps { text: string; href: string; }
interface NavbarProps { brandName: string; navItems?: NavItemProps[]; }
...
export const Navbar = (props: NavbarProps) => {
  ...
  const toggleTheme = () => setTheme(t => t === 'civitas' ? 'civitas-dark' : 'civitas');
  ...
  return (
    <div className="navbar bg-base-100/90 border-b border-base-300 backdrop-blur supports-[backdrop-filter]:bg-base-100/70">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-6">
        <a className="font-semibold text-primary text-lg" href="/">{text}</a>
