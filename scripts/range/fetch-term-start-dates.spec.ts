...
vi.mock('../lib/run-terms-query.ts', () => ({ runTermsQuery: vi.fn() }));

import { runTermsQuery } from '../lib/run-terms-query.ts';
import { fetchTermStartDates } from './fetch-term-start-dates.ts';
